...
const SearchJobs = () => {
  const JobData = [
    ...
    },
    {
      ...
      highRate: "25,000",
      description: "",
      locationCountry: "Barcelona",
    },
  ];
  const [jobList, setJobList] = useState(JobData);
  const [applyForJobs, setApplyForJobs] = useState(false);
    ...
    <Fragment>
          ...
          <Dropdown className="dropdown mb-0 custom-dropdown d-block">
            ...
            >
              ...
              <div className="text-left ml-3">
                <span className="d-block fs-16 text-black">Location</span>
              </div>
            </Dropdown.Toggle>
      ...
      <div className="d-flex flex-wrap mb-4 align-items-center">
        ...
        {/* <Dropdown className="dropdown custom-dropdown mb-0 mr-4 mt-3 mt-sm-0 mb-2">
          <Dropdown.Toggle
            variant=""
            className="btn btn-primary border border-primary text-white btn-rounded"
            role="button"
            data-toggle="dropdown"
            aria-expanded="false"
          >
        ...
        <Button
          onClick={() => setApplyForJobs(true)}
          className="btn btn-primary btn-rounded mb-0 mr-4 mt-3 mt-sm-0 mb-2"
        >
          Apply for jobs
        </Button>
        <Modal className="modal fade" show={applyForJobs}>
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Apply For Jobs</h5>
              <Button
                variant=""
                type="button"
                className="close"
                data-dismiss="modal"
                onClick={() => setApplyForJobs(false)}
              >
                <span>×</span>
              </Button>
            </div>
              ...
              >
                <div className="row">
                  ...
                  <div className="col-lg-12">
                    <div className="form-group">
                      <label htmlFor="salary" className="text-black font-w600">
                        Salary Expectation
                      </label>
                      <input
                        type="text"
