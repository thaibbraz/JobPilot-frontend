      ...
      <div className="row">
            ...
            <div className="card-body">
              <div className="media align-items-center">
                ...
                <div className="media-body text-right">
                  ...
                  <span className="fs-48 text-white font-w600">650</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card bg-success">
            <div className="card-body">
              <div className="media align-items-center">
                ...
                <div className="media-body text-right">
                  <p className="fs-18 text-white mb-2">CV views</p>
          ...
          <div className="card bg-secondary">
            <div className="card-body">
              <div className="media align-items-center">
                ...
                <div className="media-body text-right">
                  <p className="fs-18 text-white mb-2">Interview proposal</p>
                  <span className="fs-48 text-white font-w600">15</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-xl-12">
          <div className="d-sm-flex align-items-center mb-3 mt-sm-0 mt-2">
            <h4 className="text-black fs-20 mr-auto">Favorite Companies</h4>
